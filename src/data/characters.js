...
export const initialCharacters = [
  // work-1 개인 캐릭터
  {
    ...
    profile: {
      age: '27',
      gender: '남',
      personality: '냉정, 책임감, 은근한 다정함',
      custom: [
        { label: '출신', value: '북부 변경 귀족' },
        { label: '능력', value: '성광 검술 / 별빛 조작' },
      ],
    },
    relations: [
  ...
  },
  {
    ...
    profile: {
      age: '26',
      gender: '여',
      personality: '논리적, 박식, 독설가',
      custom: [
        { label: '출신', value: '왕도 마법 학원' },
        { label: '능력', value: '달빛 마법 / 결계술' },
      ],
    },
    relations: [
  ...
  // work-2 캐릭터
  {
    ...
    profile: {
      age: '21',
      gender: '남',
      personality: '낙천적, 눈치 빠름, 숨기는 것이 많다',
      custom: [
        { label: '출신', value: '도쿄 출생' },
        { label: '능력', value: '요괴어 이해 / 영적 감지' },
      ],
    },
    relations: [],
    timeline: [
